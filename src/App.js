			...
			<div>
				...
				<Container fluid className="px-4">
					...
					{this.state.searchResults?.length > 0 && (
						...
						<Routes>
							<Route path="/" element={(!this.state.error &&
									!this.state.searchResults?.length > 0 && (
										<>
											<MovieList
												title="Harry Potter"
							...
							<Route path="/tvseries" element={<MovieList
												title="tv-series"
												loading={this.state.loading}
												fetchComments={this.fetchComments}
												comments={this.state.comments}
												movies={this.state.gallery4.slice(0, 6)}
											/>} />
											<Route path="/details/:idfilm" element={<Dettagli/>}>
